...
\item Here is a web page of 40,000 sampled words
  ...
  \item Compare this to the $\alpha$ that minimizes
    ...
    method\footnote{\url{https://en.wikipedia.org/wiki/Newton\%27s_method}}. Code used for newton's method is shown
    in listing
    \SourceCode{clojure}{Functions for using newton's method}{lst:newton}{../../src/elc5370/optimization.clj}
    \SourceCode{clojure}{Functions for beta binomial distribution}{lst:newton}{../../src/elc5370/binomial.clj}
    % \begin{align*}
