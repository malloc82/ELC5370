...
\item Here is a web page of 40,000 sampled words
  ...
  \item Compare this to the $\alpha$ that minimizes
    ...
    \begin{align*}
      ...
      & = \sum_{x=1}^{26} \left( (2x+2)a^{2x+1} - (2x+2)a^{2x} + 2xa^{2x-1} + (x+1)\df{2C_xB_x}{B} a^{x} \right.\\
      & \quad \quad \quad \quad \left.  - x\df{2C_xB_x}{B} a^{x-1}\right) + 2a -2 + \df{2C_xB_x}{B} \\
      ...
      & \quad + 12a^2 - 8a + 2 + \df{4C_xB_x}{B} + 2
    \end{align*}
    \begin{align*}
